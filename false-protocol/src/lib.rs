//! FALSE Protocol types — Functional AI-native Semantic Events
//!
//! Standalone data types for the FALSE Protocol. No POLKU dependency.
//! Use these types to emit, consume, or process Occurrences in any Rust service.
